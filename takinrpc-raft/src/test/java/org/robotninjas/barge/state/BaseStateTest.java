...
public class BaseStateTest {
    ...
    public void testHaventVoted() {
        ...
        RequestVote requestVote = RequestVote.newBuilder().setCandidateId(candidate.toString()).setLastLogIndex(2).setLastLogTerm(2).setTerm(2).build();
    ...
    public void testCandidateWithLesserTerm() {
        ...
        RequestVote requestVote = RequestVote.newBuilder().setCandidateId(candidate.toString()).setLastLogIndex(2).setLastLogTerm(1).setTerm(2).build();
    ...
    public void testCandidateWithLesserIndex() {
        ...
        RequestVote requestVote = RequestVote.newBuilder().setCandidateId(candidate.toString()).setLastLogIndex(1).setLastLogTerm(2).setTerm(2).build();
